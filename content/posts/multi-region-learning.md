...
- [Part 7.1 - Progressive Delivery with Argo Rollouts](/posts/multi-region-series-part-7a-rollouts/)
  Uses Argo Rollouts for canary, blue green, and header based releases.
